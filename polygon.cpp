...
//for making a polygon
	for(a=0;a<50;a++)
	{
		putpixel(450+a,300+a,BLACK);//for right roof
		putpixel(450-a,300+a,BLACK);//for left roof
		putpixel(400,350+a,BLACK);//for left vertical line from left roof end
		putpixel(500,350+a,BLACK);//for right vertical line from right roof end
		putpixel(500-a,400,BLACK);//for horizontal line from right vertical line end
		putpixel(400+a+1,400,BLACK);//for horizontal line from left vertical line end
		putpixel(500-a-1,350,BLACK);//for horizontal line from right roof end
		putpixel(400+a,350,BLACK);//for horizontal line from left roof end
	delay(1);
	}
